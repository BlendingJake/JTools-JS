...
export class JQLParser extends Parser {
	...
	public static readonly RULE_keyword_argument = 9;
	public static readonly RULE_argument = 10;
	public static readonly RULE_arith_expr = 11;
	public static readonly RULE_arith_operator = 12;
	public static readonly RULE_factor_expr = 13;
	public static readonly RULE_factor_operator = 14;
	public static readonly RULE_power_expr = 15;
	public static readonly RULE_power_operator = 16;
	public static readonly RULE_math_value = 17;
	public static readonly RULE_value = 18;
	public static readonly RULE_primitive_value = 19;
	public static readonly RULE_list_value = 20;
	public static readonly RULE_set_value = 21;
	public static readonly RULE_object_value = 22;
	public static readonly RULE_pair = 23;
	...
	// @RuleVersion(0)
	public keyword_argument(): Keyword_argumentContext {
		let _localctx: Keyword_argumentContext = new Keyword_argumentContext(this._ctx, this.state);
	...
	// @RuleVersion(0)
	public arith_operator(): Arith_operatorContext {
		let _localctx: Arith_operatorContext = new Arith_operatorContext(this._ctx, this.state);
	...
	// @RuleVersion(0)
	public factor_expr(): Factor_exprContext {
		let _localctx: Factor_exprContext = new Factor_exprContext(this._ctx, this.state);
	...
	// @RuleVersion(0)
	public factor_operator(): Factor_operatorContext {
		let _localctx: Factor_operatorContext = new Factor_operatorContext(this._ctx, this.state);
	...
	// @RuleVersion(0)
	public power_operator(): Power_operatorContext {
		let _localctx: Power_operatorContext = new Power_operatorContext(this._ctx, this.state);
	...
	// @RuleVersion(0)
	public math_value(): Math_valueContext {
		let _localctx: Math_valueContext = new Math_valueContext(this._ctx, this.state);
	...
	public primitive_value(): Primitive_valueContext {
		let _localctx: Primitive_valueContext = new Primitive_valueContext(this._ctx, this.state);
...
export class ArgumentsContext extends ParserRuleContext {
	...
	public keyword_argument(): Keyword_argumentContext[];
	public keyword_argument(i: number): Keyword_argumentContext;
	public keyword_argument(i?: number): Keyword_argumentContext | Keyword_argumentContext[] {
		if (i === undefined) {
...
export class Keyword_argumentContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return JQLParser.RULE_keyword_argument; }
	// @Override
	public enterRule(listener: JQLListener): void {
...
export class ArgumentContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return JQLParser.RULE_argument; }
	// @Override
	public enterRule(listener: JQLListener): void {
...
export class Arith_exprContext extends ParserRuleContext {
	public factor_expr(): Factor_exprContext[];
	public factor_expr(i: number): Factor_exprContext;
	public factor_expr(i?: number): Factor_exprContext | Factor_exprContext[] {
		if (i === undefined) {
	...
	public arith_operator(): Arith_operatorContext[];
	public arith_operator(i: number): Arith_operatorContext;
	public arith_operator(i?: number): Arith_operatorContext | Arith_operatorContext[] {
		if (i === undefined) {
	...
	// @Override
	public get ruleIndex(): number { return JQLParser.RULE_arith_expr; }
	// @Override
	public enterRule(listener: JQLListener): void {
...
export class Arith_operatorContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return JQLParser.RULE_arith_operator; }
	// @Override
	public enterRule(listener: JQLListener): void {
...
export class Factor_exprContext extends ParserRuleContext {
	...
	public factor_operator(): Factor_operatorContext[];
	public factor_operator(i: number): Factor_operatorContext;
	public factor_operator(i?: number): Factor_operatorContext | Factor_operatorContext[] {
		if (i === undefined) {
	...
	// @Override
	public get ruleIndex(): number { return JQLParser.RULE_factor_expr; }
	// @Override
	public enterRule(listener: JQLListener): void {
...
export class Factor_operatorContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return JQLParser.RULE_factor_operator; }
	// @Override
	public enterRule(listener: JQLListener): void {
...
export class Power_exprContext extends ParserRuleContext {
	public math_value(): Math_valueContext[];
	public math_value(i: number): Math_valueContext;
	public math_value(i?: number): Math_valueContext | Math_valueContext[] {
		if (i === undefined) {
	...
	public power_operator(): Power_operatorContext[];
	public power_operator(i: number): Power_operatorContext;
	public power_operator(i?: number): Power_operatorContext | Power_operatorContext[] {
		if (i === undefined) {
	...
	// @Override
	public get ruleIndex(): number { return JQLParser.RULE_power_expr; }
	// @Override
	public enterRule(listener: JQLListener): void {
...
export class Power_operatorContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return JQLParser.RULE_power_operator; }
	// @Override
	public enterRule(listener: JQLListener): void {
...
export class Math_valueContext extends ParserRuleContext {
	...
	public LPAREN(): TerminalNode | undefined { return this.tryGetToken(JQLParser.LPAREN, 0); }
	public arith_expr(): Arith_exprContext | undefined {
		return this.tryGetRuleContext(0, Arith_exprContext);
	}
	public RPAREN(): TerminalNode | undefined { return this.tryGetToken(JQLParser.RPAREN, 0); }
	public WS(): TerminalNode[];
	public WS(i: number): TerminalNode;
	public WS(i?: number): TerminalNode | TerminalNode[] {
		if (i === undefined) {
	...
	// @Override
	public get ruleIndex(): number { return JQLParser.RULE_math_value; }
	// @Override
	public enterRule(listener: JQLListener): void {
...
export class ValueContext extends ParserRuleContext {
	...
	public primitive_value(): Primitive_valueContext | undefined {
...
export class Primitive_valueContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return JQLParser.RULE_primitive_value; }
	// @Override
	public enterRule(listener: JQLListener): void {
